...
public class ExibirDados {
    ...
    public static String timesMaisVencedores2008 = GetDados.getTimeQueMaisVenceu2008().toString();
    public static String estadoComMenosJogos = String.valueOf(GetDados.getEstadoComMenosJogos());
